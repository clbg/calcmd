...
export default function Syntax() {
  return (
    <section id="syntax" style={{ maxWidth: 860, margin: '0 auto', padding: '3rem 2rem' }}>
      <div style={{ fontSize: '1.5rem', fontWeight: 700, marginBottom: '0.5rem' }}>Syntax at a glance</div>
      <p style={{ color: 'var(--muted)', marginBottom: '2rem' }}>Two places to put formulas. That's it.</p>
      ...
      <div style={codeStyle}>
        <span style={{ color: 'var(--muted)' }}>| <strong>Total</strong> | | | </span>
        <span style={{ color: 'var(--accent2)' }}><strong>8.50=sum(Total)</strong></span>
        <span style={{ color: 'var(--muted)' }}> |</span>
      </div>
      ...
      <div style={codeStyle}>
        <span style={{ color: 'var(--muted)' }}># Aggregations</span><br />
        <span>sum(col) &nbsp; avg(col) &nbsp; min(col) &nbsp; max(col) &nbsp; count(col)</span><br /><br />
        <span style={{ color: 'var(--muted)' }}># Math</span><br />
        <span>round(n, d) &nbsp; abs(n) &nbsp; floor(n) &nbsp; ceil(n)</span><br /><br />
        <span style={{ color: 'var(--muted)' }}># Conditional</span><br />
