        ...
        {onShare && (
          ...
          >
            {shared === 'ok' ? (
              ...
              <>
                <svg width="13" height="13" viewBox="0 0 16 16" fill="currentColor">
                  <path d="M8 1.5a.75.75 0 0 1 .75.75V8h2.5a.25.25 0 0 1 .177.427l-3.5 3.5a.25.25 0 0 1-.354 0l-3.5-3.5A.25.25 0 0 1 4.25 8h2.5V2.25A.75.75 0 0 1 8 1.5zM2.75 13a.75.75 0 0 0 0 1.5h10.5a.75.75 0 0 0 0-1.5H2.75z" />
                </svg>
                Share
              </>
            )}
